...
<nav class="navbar navbar-expand-sm bg-light navbar-light">
    ...
    <!-- Links -->
    <ul class="navbar-nav ml"style="margin-left: 84rem;">
        <li class="nav-item">
...
<nav class="navbar navbar-expand-lg navbar-white bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
            ...
            <li class="nav-item" style="margin-left: 80rem;">
            ...
            <div class="btn btn-outline-light btn-lg border text-left">
                ...
                <div class="collapse" id="layoutcollapse">
                    <div class="card card-body"><br>
                        <form action=""><label class="select control-label" for="image_on_click">Video Display Mode</label><br>
                            <select class="form-control" id="exampleFormControlSelect1">
                                <option>Popup/Lightbox</option>
            ...
            <div class="btn btn-outline-light btn-lg border text-left">
                ...
                <div class="collapse" id="layout2collapse">
                    <div class="card card-body">
                        <form action=""><label class="select control-label" for="image_on_click">Caption Style</label>
                            <select class="form-control" id="exampleFormControlSelect1">
        ...
        <div class="btn-group-vertical " style="width: 20rem;">
            <div class="btn btn-outline-light btn-lg border text-left">
                ...
                <div class="collapse" id="layout3collapse">
                    <div class="card card-body">
                        <form action=""><label class="select control-label" for="image_on_click">Icon Types</label>
                            <select class="form-control" id="exampleFormControlSelect1">
        ...
        <div class="btn-group-vertical " style="width: 20rem;">
            <div class="btn btn-outline-light btn-lg border text-left">
                ...
                <div class="collapse" id="layout4collapse">
                    <div class="card card-body">
                        <form action=""><label class="select control-label" for="image_on_click">Border Size</label>
                            <input type="range" class="form-control-range" id="formControlRange" data-slider-min="0" data-slider-max="10"><br>
...
<section>
    <div class="container row " style="position: absolute;left: 26rem;top: 12rem;width: 100%;">
    ...
    <div class="container row ml-1" style="position: absolute;left: 46rem;top: 12rem;width: 100%;">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRm3IpKfxfZUBDEwEXAuA4DrNB1PRYYUDWi6g&usqp=CAU" alt="Himachal Bir billing view">
    </div>
    <div class="container row ml-1" style="position: absolute;left: 67rem;top: 12rem;width: 100%;">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRm3IpKfxfZUBDEwEXAuA4DrNB1PRYYUDWi6g&usqp=CAU" alt="Himachal Bir billing view">
    </div>
</section>
