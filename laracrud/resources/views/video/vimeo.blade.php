                ...
                <div class="btn btn-outline-light btn-lg border text-left">
                    ...
                    <div class="collapse" id="layoutcollapse">
                        <div class="card card-body"><br>
                            <form class="zach" style="color:black;" action="{{ route('video.store') }}" method="post">
                                @csrf
                                <label class="select control-label" for="video_mode">Video Display Mode</label><br>
{{--                                <input type="text" name="video_mode" id="video_mode">--}}
                                <select class="form-control" value="Popup/Lightbox" name="video_mode" id="video_mode">
                                    <option value="Popup/Lightbox">Popup/Lightbox</option>
                                    <option value="Inline">Inline</option>
                                </select><br>
                                <label class="select control-label" for="video_row">Videos per row</label>
{{--                                <input type="text" name="video_row" id="video_row">--}}
                                <select class="form-control" name="video_row" id="video_row">
                                ...
                                <label for="margin">Margin Between Images</label><br>
{{--                                <input type="text" name="margin" id="margin">--}}
                                <input type="range" class="form-control-range" name="margin" id="margin" data-slider-min="0" data-slider-max="10"><br>
                                <label class="select control-label" for="hover">Hover</label>
{{--                                <input type="text" name="hover" id="hover">--}}
                                <select class="form-control" name="hover" id="hover">
                                ...
                                <fieldset>
                                    ...
                                    <input type="checkbox" name="padding['pad'][]" value="2px">2px<br>
                                    <input type="checkbox" name="padding['pad'][]" value="4px">4px<br>
                                    <input type="checkbox" name="padding['pad'][]" value="6px">6px<br>
                                    <input type="checkbox" name="padding['pad'][]" value="8px">8px<br>
                                    <input type="text" name="padding['pad'][]" id="padding">
                                </fieldset>
