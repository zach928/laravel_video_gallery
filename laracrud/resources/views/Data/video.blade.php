...
@section('main')
    ...
    <div class="container">
        <form class="zach" style="color:black;" action="{{ route('Data.store') }}" method="post">
            @csrf
        <div class="col-3">
            <div class="btn-group-vertical " style="width: 20rem;">
                <div class="btn btn-outline-light btn-lg border text-left">
                    ...
                    <div class="collapse" id="layoutcollapse">
                        <div class="card card-body zach" style="color:black;"><br>

                                <label class="select control-label" for="data">Video Display Mode</label><br>
                                {{--                                <input type="text" name="video_mode" id="video_mode">--}}
                                <select class="form-control" value="Popup/Lightbox" name="data[display]" id="data">
                                    <option value="Popup/Lightbox">Popup/Lightbox</option>
                                    <option value="Inline">Inline</option>
                                </select><br>
                                <label class="select control-label" for="data">Videos per row</label>
                                {{--                                <input type="text" name="video_row" id="video_row">--}}
                                <select class="form-control" name="data[video_per_row]" id="data">
                                    <option value="Seven">Seven</option>
                                    <option  value="Eight">Eight</option>
                                    <option value="Nine">Nine</option>
                                    <option value="Ten">Ten</option>
                                    <option  value="Eleven">Eleven</option>
                                    <option  value="Twelwe">Twelwe</option>
                                </select><br>
                                <label for="data">Margin Between Images</label><br>
                                {{--                                <input type="text" name="margin" id="margin">--}}
                                <input type="range" class="form-control-range" name="data[margin]" id="data" data-slider-min="0" data-slider-max="10"><br>
                                <label class="select control-label" for="hover">Hover</label>
                                {{--                                <input type="text" name="hover" id="hover">--}}
                                <select class="form-control" name="data[hover]" id="data">
                                    <option value="None">None</option>
                                    <option value="Fade Lighten">Fade Lighten</option>
                                    <option value="Fade Darken">Fade Darken</option>
                                    <option value="Shine Circle">Shine Circle</option>
                                    <option value="Blur">Blur</option>
                                    <option value="Color Rotation">Color Rotation</option>
            ...
            <div class="btn-group-vertical " style="width: 20rem;">
                <div class="btn btn-outline-light btn-lg border text-left">
                    ...
                    <div class="collapse" id="layout1collapse">
                        <div class="card card-bodyzach" style="color:black;"><br>
                            <div class="custom-control custom-switch border">

                                <input type="checkbox" class="custom-control-input" name="data[Auto-Play_videos]" id="customSwitch1">
                                <label class="custom-control-label" for="customSwitch1">Auto Play Videos</label>
                            </div><br>
                            <div class="custom-control custom-switch border">
                                <input type="checkbox" name="data[Loop_videos]" class="custom-control-input" id="customSwitch2">
                                <label class="custom-control-label" for="customSwitch2">Loop Videos</label>
                            </div><br>
                            <div class="custom-control custom-switch border">
                                <input type="checkbox" name="data[Mute_youtube_videos]" class="custom-control-input" id="customSwitch3">
                                <label class="custom-control-label" for="customSwitch3">Mute Youtube Videos</label>
                            </div><br>
                            <div class="custom-control custom-switch border">
                                <input type="checkbox" name="data[Hide_You_tube_logo]" class="custom-control-input" id="customSwitch4">
            ...
            <div class="btn-group-vertical " style="width: 20rem;">
                <div class="btn btn-outline-light btn-lg border text-left">
                    ...
                    <div class="collapse" id="layout2collapse">
                        <div class="card card-body zach" style="color:black;">
                                <label class="select control-label" for="image_on_click">Caption Style</label>
                                <select class="form-control" name="data[caption_style]" id="exampleFormControlSelect1">
                                    <option value="No caption">No Caption</option>
                                    <option value="Hover caption">Hover Caption</option>
                                    <option value="Static Caption">Static Caption</option>
                                    <option value="Static Outer Caption">Static Outer Caption</option>
                                </select><br>
                                <label for="formControlRange">Caption Font Size</label>
                                <input type="range" name="data[caption_font_size]"  class="form-control-range" id="formControlRange" data-slider-min="0" data-slider-max="10"><br>

                                <label class="select control-label" for="image_on_click">Changing Background Color</label>
                                <div class="card">
                                    <input type="text" name="data[changing_background_color]" id="image_on_click">
                                </div>

                                <label class="select control-label" for="image_on_click">Caption Font Color</label>
                                <div class="card">
                                    <input type="text" name="data[Caption_Font_Color]" id="image_on_click">
                                </div>
                            </div>
                    </div>
                </div>
            ...
            <div class="btn-group-vertical " style="width: 20rem;">
                <div class="btn btn-outline-light btn-lg border text-left">
                    ...
                    <div class="collapse" id="layout3collapse">
                        <div class="card card-body zach" style="color:black;">
                            <label class="select control-label" for="image_on_click">Icon Types</label>
                                <select class="form-control" name="data[icon types]" id="image_on_click">
                                    ...
                                    <option value="Vimeo Logo">Vimeo Logo</option>
                                </select><br>
                                <label for="formControlRange">Icon Size</label>
                                <input type="range" class="form-control-range" name="data[icon size]" id="formControlRange" data-slider-min="0" data-slider-max="10"><br>

                                <label class="select control-label" for="image_on_click">Icon color</label>
                                <div class="card">
                                    <input type="text" name="data[icon color]"id="image_on_click">
                                </div>

                                <label class="select control-label" for="image_on_click">Icon Hover Color</label>
                                <div class="card">
                                    <input type="text" name="data[icon hover color]" id="image_on_click">
                                </div>
                            </div>
                    </div>
                </div></div>
            <div class="btn-group-vertical " style="width: 20rem;">
                <div class="btn btn-outline-light btn-lg border text-left">
                    ...
                    <div class="collapse" id="layout4collapse">
                        <div class="card card-body zach" style="color:black;">
                            <label class="select control-label" for="image_on_click">Border Size</label>
                                <input type="range" class="form-control-range" id="formControlRange" name="data[border size]" data-slider-min="0" data-slider-max="10"><br>
                            <label class="select control-label" for="image_on_click">Border color</label>
                                <div class="card">
                                    <input type="text" name="data[border color]" id="">
                                </div>
                            </div>
                    </div>
                </div></div>
                ...
                <div class="btn btn-outline-light btn-lg border text-left">
                    ...
                    <div class="collapse" id="layout5collapse">
                        <div class="card card-body">
                            <span class="zach" style="color:black;" >
                                <label class="select control-label" for="image_on_click">Blur</label>
                                <input type="range" class="form-control-range" id="image_on_click" name="data[blur]" data-slider-min="0" data-slider-max="10"><br>
                                <label class="select control-label" for="image_on_click">Spread</label>
                                <input type="range" class="form-control-range" id="image_on_click" name="data[spread]" data-slider-min="0" data-slider-max="10"><br>
                                <label class="select control-label" for="image_on_click">Horizontal Shift</label>
                                <input type="range" class="form-control-range" name="data[horizontal shift]" id="image_on_click" data-slider-min="0" data-slider-max="10"><br>
                                <label class="select control-label" for="image_on_click">Vertical Shift</label>
                                <input type="range" class="form-control-range" name="data[vertical shift]" id="image_on_click" data-slider-min="0" data-slider-max="10"><br>
                                <label class="select control-label" for="image_on_click">Shadow color</label>
                                <div class="card">
                                    <input type="text" name="data[shadow color]" id="image_on_click">
                                </div>
                            </span>
                        </div>
                    </div>
            ...
            <div class="btn-group-vertical " style="width: 20rem;">
                <div class="btn btn-outline-light btn-lg border text-left">
                    ...
                    <div class="collapse" id="layout6collapse"><br>
                        <textarea name="data[custom]" id="layout6collapse" cols="28" rows="8"></textarea>
                    </div></div></div></div>
        <div class="btn-group-vertical " style="width: 20rem;">
            <div class="px-md-5 btn btn-success border bg-light ml-3" >
                <button type="submit" class="btn btn btn-success btn-lg btn-block item-bulk-set-btn">Save</button>
            </div></div>
        </form>
    </div>
